            ...
            item {
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = "The Mythic Monthly Draw is a free loyalty programme held on the 1st of every month. No purchase is required to participate.\n\nELIGIBILITY: Your active upload streak must meet the monthly threshold to enter. Thresholds progress each month the draw runs: 10 days (Month 1), 30 days (Month 2), 50 days (Month 3), 70 days (Month 4), and 100 days from Month 5 onwards. If no users qualify in a given month, the threshold does not increase for the following month.\n\nWINNERS & PRIZES: Three winners are selected each month via a streak-weighted lottery. Every 10 days of your streak earns one entry ticket. First place receives 3 months PRO + a Gold Crown + a Profile Banner. Second place receives 1 month PRO + a Silver Crown + a Profile Banner. Third place receives 2 weeks PRO + a Bronze Crown + a Profile Banner. If a winner is already on PRO, they receive ULTRA instead. If a winner is already on ULTRA, their ULTRA tier is extended and they receive a permanent Mythic Champion badge.\n\nALL ENTRANTS: Every user who enters the draw but does not win receives a +30% daily upload boost for 30 days and progresses their Mythic tier badge (Bronze, Silver, Gold, or Diamond) based on consecutive months entered.\n\nREPEAT PROTECTION: A user who wins any placed prize may not win again for 3 months. They remain eligible for all-entrant rewards during this period.\n\nGENERAL: Eligibility, timing, and winner processing may vary by timezone, maintenance windows, or technical constraints. PicFlick may verify eligibility, prevent abuse, and disqualify users who violate platform rules. Where required by law, local restrictions or exclusions may apply. Draw structure, rewards, and timing may be changed, paused, or discontinued at PicFlick's discretion.",
                            fontSize = 14.sp,
                            color = textColor,
                            lineHeight = 22.sp
                        )
